        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a class="btn btn-success" href="{{ route('adminlayanan.create') }}" style="color:white;">+ Tambah
                        Layanan</a></button>
                                                ...
                                                <td style="background-color: white;">
                                                    <form>
                                                        <a class="btn btn-sm btn-success"
                                                            href="{{ route('adminlayanan.edit', [$layanan->id]) }}">Edit</a>
                                                    </form>
                                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                        action="{{ route('adminlayanan.destroy', [$layanan->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
